...
- Create a public `stephenlclarke_grpc-swift-nio-transport` project.
...
semantics. The C zlib shim has no executable Swift coverage and is excluded
from that metric, while it remains in static analysis.
